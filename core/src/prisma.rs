...
pub static DATAMODEL_STR: &'static str =
    include_str!("/Users/deondreenglish/Projects/work/Speak/core/prisma/schema.prisma");
...
pub mod user {
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_user { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: user struct $ struct_name { # [serde (rename = "id")] id : i32 , # [serde (rename = "name")] name : String } [$ ($ scalar_field) , +] } } ; }
